...
(function() {
    ...
    var canvas, ctx,
        ...
        text = [
            ...
            {word: "САЙТ НАХОДИТСЯ*В РАЗРАБОТКЕ", time: 3500, effect: 2 },
            {word: "МОГУТ БЫТЬ*ГЛЮКИ", time: 3500, effect: 2 },
        ],
        mouse = new Vector(),
        isDown = false,
    ...
    function resize(e) {
        ...
        height  = canvas.height  = document.getElementsByClassName('welcome')[0].offsetHeight;
    }
